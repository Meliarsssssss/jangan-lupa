                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($b->status == "New") : ?>
                                            ...
                                            <a href="<?= site_url('backend/barang/delete/' . $b->id_barang) ?>"  onclick="deleteConfirm(this)"><button type="button" class="btn btn-danger" title="Hapus"><i class=" fa-solid fa-trash"></i></button></a>
                                        <?php endif ?>
                                    </td>
                                </tr>
                            <?php endforeach ?>
