        ...
        <div class="content">
            <div class="container d-flex justify-content-center" >
                <?php foreach ($lelang as $b) : ?>
                    <div class="col-7 p-4 card " style="width: 15rem; text-align: center">
                        <div style="height: 18rem;" >
                            <img src="<?= empty($b->gambar) ? base_url('assets/images/no_image.png')  : base_url('upload/barang/' . $b->gambar) ?>"  >
                        </div>
                        <div class="card-body">
                            <h6 class="list-group-item bg-info"><?= $b->deskripsi ?></h6>
                            <h6 class="list-group-item"><?= $b->nama_barang ?></h6>
                        </div>
