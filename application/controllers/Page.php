...
class Page extends CI_Controller
{
	...
	public function index()
    {
       $data['activeUser'] = $this->authfront_model->current_user(); //menampilkan data dari login user
		...
		$data['v_dashboard'] = $this->lelang_model->get_pepet();
    ...
    public function login()
    {
        ...
        $this->load->view('login_frontend', $data);
    }
    ...
    {
        $data['activeUser'] = $this->authfront_model->current_user();
        $data['pemenang'] = $this->lelang_model->get_pemenang_Lelang($data['activeUser']->id_masyarakat);
